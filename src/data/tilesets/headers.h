...
const struct Tileset gTileset_SpaceRocket =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_SpaceRocket,
    .palettes = gTilesetPalettes_SpaceRocket,
    .metatiles = gMetatiles_SpaceRocket,
...
const struct Tileset gTileset_Oldale =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Oldale,
    .palettes = gTilesetPalettes_Oldale,
    .metatiles = gMetatiles_Oldale,
    .metatileAttributes = gMetatileAttributes_Oldale,
    .callback = NULL,
};
