...
static void CoordEventWeather_RainThunderstorm(void);
...
static const struct CoordEventWeather sCoordEventWeatherFuncs[] =
{
    ...
    { COORD_EVENT_WEATHER_RAIN_THUNDERSTORM, CoordEventWeather_RainThunderstorm },
    { COORD_EVENT_WEATHER_THUNDERSTORM,      CoordEventWeather_Thunderstorm },
