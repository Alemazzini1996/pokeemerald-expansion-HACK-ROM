...
const u8 gText_CleanseTagTurnOn[] = _("Sprayed shoes with Repellent.\nWild encounters will be avoided.{PAUSE_UNTIL_PRESS}");
const u8 gText_CleanseTagTurnOff[] = _("Wiped off Repellent.\nYou may encounter wild POKéMON.{PAUSE_UNTIL_PRESS}");
