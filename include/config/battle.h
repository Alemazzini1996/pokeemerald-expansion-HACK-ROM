...
// Eg: Replace with VAR_UNUSED_0x40F9 so you can use VAR_TERRAIN for that feature.
#define VAR_TERRAIN                 0x40F9     // If this var has a value, assigning a STATUS_FIELD_xx_TERRAIN to it before battle causes the battle to start with that terrain active
...
#define B_THUNDERSTORM_TERRAIN      FALSE      // If TRUE, overworld Thunderstorm generates Electric Terrain as in Gen 8.
