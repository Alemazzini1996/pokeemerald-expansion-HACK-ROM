...
#define B_WEATHER_THUNDERSTORM_TEMPORARY     (1 << 14)
#define B_WEATHER_THUNDERSTORM_PERMANENT     (1 << 15)
#define B_WEATHER_THUNDERSTORM               (B_WEATHER_THUNDERSTORM_TEMPORARY | B_WEATHER_THUNDERSTORM_PERMANENT)
