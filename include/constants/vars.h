...
#define VAR_IVY_EVIE_HOUSE_STATE                         0x404E // Ivy Evie EV training IV trainining MoveRelearner house in Fallarbor
...
#define VAR_DAYNIGHT                                     0x4083 // Day Night for timed wild encounters
...
#define VAR_POKEVIAL_CHARGES                            0x4091 // PokeVial charges
...
#define VAR_POKEVIAL_MAX_CHARGES                        0x409B // PokeVial max charges
...
#define VAR_TERRAIN                                      0x40F9 // Battle Terrain Effect
